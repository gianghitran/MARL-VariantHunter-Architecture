...
- DOT: `experiments/results/marl_runs/rq1ho_s44_e50/attack_handoff/APT38_evolved_provenance.dot`
- Quality valid: `True`
- Nodes: `43`
- Edges: `58`
- Clusters: `4`
...
## Pruned Techniques
- `T1189`: weak transition and stronger/equal bypass (incoming=0.1750, bypass=0.1750)
