...
- DOT: `experiments/results/marl_runs/rq1ho_s42_e50/attack_handoff/APT32_evolved_provenance.dot`
- Quality valid: `True`
- Nodes: `45`
- Edges: `59`
- Clusters: `4`
...
## Pruned Techniques
- `T1588.007`: weak transition and stronger/equal bypass (incoming=0.2100, bypass=0.4604)
