...
- DOT: `.\result_handoff/APT28_composite_provenance.dot`
- Quality valid: `True`
- Nodes: `67`
- Edges: `91`
- Clusters: `6`
- Total reward: `0.8590`
- Transition quality: `0.6732`
...
5. `T1046` Network Service Discovery (discovery) -> score=0.6335, bridge=socket
6. `T1071.004` DNS (command-and-control)
